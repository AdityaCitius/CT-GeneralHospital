...
import { confirmPasswordValidators, contactNumberValidator, dobValidator, emailValidator, firstNameValidator, lastNameValidator, passwordValidators } from './validators';
